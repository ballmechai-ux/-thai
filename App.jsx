...
<head>
    ...
    <style>
        * {
        ...
        /* 🟠 ปรับแต่งตำแหน่งและขนาดรูปพระพุทธรูปสีส้มตามแอปของเฮีย */
        .buddhist-icon {
            position: absolute;
            top: 6px;
            right: 6px;
...
<script>
    ...
    const BUDDHIST_DAYS_2026 = {
        ...
        '2026-11-03': 'แรม ๘ ค่ำ เดือน ๑๑', '2026-11-09': 'แรม ๑๔ ค่ำ เดือน ๑๑', '2026-11-18': 'ขึ้น ๘ ค่ำ เดือน ๑๒', '2026-11-25': 'ขึ้น ๑๕ ค่ำ เดือน ๑๒ (วันลอยกระทง)',
        '2026-12-02': 'แรม ๘ ค่ำ เดือน ๑๒', '2026-12-09': 'แรม ๑๕ ค่ำ เดือน ๑๒', '2026-12-18': 'ขึ้น ๘ ค่ำ เดือน ๑', '2026-12-25': 'ขึ้น ๑๕ ค่ำ เดือน ๑'
    };
    ...
    // 🕉️ ฟังก์ชันวาดรูปพระพุทธรูปปางสมาธิสีส้ม (ถอดแบบจากรูปของเฮีย)
    function getBuddhaSVG() {
        return `
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            <path d="M50 15 C52 23 48 23 50 28 Z" fill="#FF8C00"/>
            <circle cx="50" cy="34" r="7" fill="#FF8C00"/>
            <path d="M42 32 C41 35 43 37 43 37" stroke="#FF8C00" stroke-width="1.5" fill="none"/>
            <path d="M58 32 C59 35 57 37 57 37" stroke="#FF8C00" stroke-width="1.5" fill="none"/>
            ...
            <ellipse cx="50" cy="65" rx="6" ry="2.5" fill="#FFA500"/>
        </svg>`;
    }
    ...
    function renderCalendar() {
        ...
        for (let day = 1; day <= totalDays; day++) {
            ...
            if (lunar.isBuddhistDay) {
                ...
                // 🟠 ฝังรูปพระพุทธรูปสีส้มของเฮียลงตำแหน่งขวาบนของกล่องวันพระ
